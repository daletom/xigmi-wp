...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190911_xigmimampinstall_bbc408a8c4ca0a768736_20190911174901_archive.zip';
	const ARCHIVE_SIZE		 = '104762725';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bbc408a-11174901';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.20==');
		self::log('----------------------------------------------------');
